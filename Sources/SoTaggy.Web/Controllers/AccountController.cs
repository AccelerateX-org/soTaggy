...
namespace SoTaggy.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public static readonly string RoleArtworkAdmin = "ArtworkAdmin";
        public static readonly string RoleTaggingAdmin = "TaggingAdmin";
        public static readonly string RoleAnalyst = "Analyst";

        /// <summary>
        /// Implizite Rolle
        /// </summary>
        public static readonly string RoleTagger = "Tagger";
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                else
                {
                    ...
                    {
                        var rootUser = new ApplicationUser() { UserName = model.UserName };
